  ...
  void addData() {
    ...
    final data1 = <String, dynamic>{
      ...
      "Detailed_description": "The Dattatreya Temple stands at the east end of the Tachapal Tol,"
          ...
          "befitting the deity housed within. The itinerant residents may have been offered alternate accommodations at the nearby Pujari "
          "Math compound, as suggested by a contemporary chronicle."
          "Secondly—and much later, in 1849—a two-story porch and cupola were added to the west side of the building over the front "
          "entrance, breaking the symmetry of the sattal form, which sTill manifested itself from the exterior. The addition of this"
          " porch was clearly not foreseen in the original design of the building. For instance, Slusser notes that the porch railings "
